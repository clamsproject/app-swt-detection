...
class EfficientnetSmallExtractor(ExtractorModel):
    ...
    def __init__(self):
        ...
        self.model.classifier = torch.nn.Identity()
        self.preprocess = EfficientNet_V2_S_Weights.transforms()
...
class EfficientnetMediumExtractor(ExtractorModel):
    ...
    def __init__(self):
        ...
        self.model.classifier = torch.nn.Identity()
        self.preprocess = EfficientNet_V2_M_Weights.transforms()
...
class EfficientnetLargeExtractor(ExtractorModel):
    ...
    def __init__(self):
        ...
        self.model.classifier = torch.nn.Identity()
        self.preprocess = EfficientNet_V2_L_Weights.transforms()
...
class Resnet152Extractor(ExtractorModel):
    name = "resnet152"
    def __init__(self):
        self.model = resnet152(weights=ResNet152_Weights.IMAGNET1K_V1)
        self.model.fc = torch.nn.Identity()
...
class BN_Vgg16Extractor(ExtractorModel):
    ...
    def __init__(self):
        ...
        self.model.classifier = self.model.classifier[:-1]
        self.preprocess = VGG16_BN_Weights.IMAGENET1K.transforms()
